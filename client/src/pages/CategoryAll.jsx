              ...
              >
                ...
                <div className="w-[700px] flex flex-col md:gap-8 gap-6">
                  ...
                  <div className="md:text-lg xsm:block hidden text-sm text-gray-600">
                    Discover the dynamic world of global economics. Unravel
                    trade dynamics, supply-demand interplay, and the impact of
                    tariffs and trade agreements on economies worldwide.
                  </div>
